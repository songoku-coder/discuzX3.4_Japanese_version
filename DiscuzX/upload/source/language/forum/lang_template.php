 ...
 *
 *      Translate by sunjian 2018/05/16
 *      Contact : xiyuan94@gmail.com
 */

$lang = array (
  'activity_jointime' => '申請時間',
  'activity_member_unit' => '人',
  'activity_new_join' => '承認',
  'activity_payment' => '個人コスト',
  'activity_self' => '自払',
  'leaveword' => 'コメント',
  'payment_unit' => '円',
  'activity_allow_join' => '参加可',
  'activity_applylist' => 'イベント応募者',
  'activity_applylist_manage' => '応募者管理',
  'activity_cant_audit' => '未審査',
  'activity_do_replenish' => '改善待ち',
  ...
  'close' => '閉じる',
  'confirm' => '承認',
  'extension_project' => '拡張項目',
  'homepage' => 'ホーム',
  'no_informations' => 'NO Message',
  'send_notification' => '知らせる',
  'send_pm' => 'Message',
  'status' => '状態',
  'to_improve' => '改善',
  'views' => '確認',
  'activity_already' => '応募人数',
  'activity_content' => 'イベント',
  'activity_space' => '場所',
  'activity_start_between' => '$activity[starttimefrom]から$activity[starttimeto]決定',
  ...
  'confirms' => '確定',
  'quickclear' => 'クリア',
  'quickclear_avatar' => '画像クリア',
  'quickclear_crime_avatar_nums' => 'ユーザ $crimeauthor のプロフィール画像は $crimenum_avatar 回クリア',
  'quickclear_crime_customstatus_nums' => 'ユーザ $crimeauthorの肩書は $crimenum_customstatus 回クリア',
  'quickclear_crime_sightml_nums' => 'ユーザ $crimeauthor の個人紹介は$crimenum_sightml 回クリア',
  'quickclear_customstatus' => '肩書クリア',
  'quickclear_sightml' => '個人紹介クリア',
  'submit' => '提出',
  'e_attach_del' => '削除',
  'e_attach_mediacode' => '動画コードを追加',
  'e_attach_url' => '添付ファイルURL',
  'highest_right' => '権限',
  'readperm' => '閲覧権限',
  'update' => '更新',
  'upload_msg' => '$attach[filenametitle] {LF}upload日付: $attach[dateline] {LF}ファイルサイズ: $attach[attachsize]',
  'delete' => '削除',
  'follow_quickreply' => '返信',
  'follow_relay' => 'Reply',
  'poston' => '投稿日時',
  'forumlist' => 'フォーラムリスト',
  'forumlist_allforum' => '全部フォーラム',
  'forumlist_myfav' => 'ブックマック',
  'forumlist_recent' => '閲覧履歴',
  'search' => '検索',
  'description' => '説明',
  'save_to_album' => 'アルバムに保存',
  'post_meanwhile_relay' => '同時にReply',
  'reply' => '返信',
  'view_all_replies' => '全部の返信を確認',
  'all' => '全部',
  'announcement' => '宣言',
  'author' => '作者',
  'month' => '月',
  ...
  'year' => '年',
  'attachment' => '添付',
  'buy_all_attch' => '全部添付を購入',
  'download' => '添付ダウンロード',
  'free_buy' => '無料で購入',
  'pay_attachment' => '添付を購入',
  'pay_author_income' => '作者所得',
  'pay_balance' => '購入後残高',
  'price' => '値段',
  'status_download' => '該当するグループ成員で無料でダウンロード可',
  'status_insufficient' => ' {$_G[setting][extcredits][$_G[setting][creditstransextra][1]][title]}が不足で、ダウンロードできません',
  'attachment_buy_not' => '誰も購入していません',
  'pay_view' => '記録',
  'time' => '時間',
  'username' => 'ユーザ',
  'collection' => '淘帖',
  ...
  'collection_title_exceed' => '"タイトルは "+titlelimit+"Byte以内で入力"',
  'collection_sortby_coomentnum' => 'コメント数でソート',
  'collection_sortby_follownum' => '購読数でソート',
  'collection_sortby_threadnum' => 'テーマ数でソート',
  'collection_sortby_update' => '作成時でソート',
  'collection_backcollection' => 'Back',
  'collection_comment_submit' => 'コメント',
  'collection_commentlist' => 'コメントリスト',
  'collection_followlist' => '購読ユーザリスト',
  'collection_norate' => 'まだ評価なし',
  'collection_ratecollection' => '评价淘专辑',
  'collection_rated' => '您已评分:',
  'collection_totalrates' => '(全部{$_G[collection][ratenum]}回評価)',
  'collection_comment_specthread' => '《$thread[subject]》対してのコメント：',
  ...
  'collection_username' => 'User:',
  'invite' => '招待',
  'collection_commentnum' => 'コメント',
  'collection_createtime' => '作成',
  'collection_follow' => '購読',
  'collection_index_keywords' => 'キーワード',
  'collection_lastthread' => '最新テーマ',
  'collection_lastupdate' => '最後更新',
  'collection_nocollection' => '还没有淘专辑，快来<a href="forum.php?mod=collection&action=edit">创建</a>吧',
  'collection_threadnum' => 'テーマ',
  'collection_all' => '所有专辑',
  'collection_my' => '我的专辑',
  ...
  'index_guests' => '人未登録',
  'index_invisibles' => 'ステルス',
  'index_members' => ' 会員',
  'index_mostonlines' => ' 最大記録',
  'index_posts' => '投稿',
  'index_today' => '今日',
  'index_yesterday' => '昨日',
  'my_posts' => 'マイ投稿',
  'never' => '从未まだ',
  'on' => 'に',
  'online_only_guests' => '現在は会員と未ログインの方がオンラインしています',
  'onlinemember' => 'オンライン会員人数:',
  'onlines' => '　　全オンライン人数：',
  'private_forum' => '私密版块',
  'show_newthreads' => '最新返信',
  'spread' => '收起/展开',
  'total' => '总计',
  'url_link' => '链接到外部地址',
  'welcome_new_members' => 'ようこそ新会員',
  'attachcredits' => '下载积分',
  'attachment_buy' => '购买',
  ...
  'trade_seller_remark' => '備考',
  'trade_seller_remark_comment' => '200字以内',
  'trade_units' => '円',
  'save' => '保存',
  ...
  'hide_preview' => 'プレビュー隠し',
  'collapse_preview' => 'プレビュー閉じる',
  'hot_thread' => '人気',
  'hidden' => '隠し',
  'hiderecover_tips' => '隠し状態に戻る',
  'hiderecover' => '隠し',
  'content_actions' => '他の操作',
);
